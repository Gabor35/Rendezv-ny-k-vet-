...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 06. 12:18
...
(19, 'Retro Fesztivál', 'Budapest, Aréna', '2025-06-15 18:00:00', '80-as és 90-es évek legnagyobb slágerei élőben!', 'retrofesztival.jpg'),
(20, 'Balatoni Borfesztivál', 'Balatonfüred, Tagore sétány', '2025-08-10 16:00:00', 'A Balaton legjobb borai egy helyen, kóstolókkal és zenés programokkal.', 'borfesztival.jpg'),
(21, 'Jazz Est', 'Szeged, Dóm tér', '2025-09-22 19:30:00', 'Kellemes jazz zene élő előadásban egy hangulatos helyszínen.', 'jazzest.jpg'),
(22, 'Mangalica Fesztivál', 'Debrecen, Nagyerdő', '2025-10-05 12:00:00', 'Hagyományos magyar ételek és kézműves termékek várják az érdeklődőket.', 'mangalicafesztival.jpg'),
(23, 'Színházi Premier', 'Győr, Nemzeti Színház', '2025-11-28 19:00:00', 'Új színházi előadás premierje neves színészekkel.', 'szinhaz.jpg'),
(24, 'E-sport Bajnokság', 'Budapest, Gamer Aréna', '2026-01-20 10:00:00', 'Nézd élőben a legjobb e-sport csapatok csatáit.', 'esportbajnoksag.jpg'),
(25, 'Csillagászat Éjszakája', 'Pécs, Planetárium', '2026-03-12 21:00:00', 'Távcsöves bemutató és előadás az univerzum csodáiról.', 'csillagaszatejszakaja.jpg'),
(26, 'Kézműves Sörfesztivál', 'Székesfehérvár, Belváros', '2026-05-17 14:00:00', 'Kóstold meg a legjobb kézműves söröket hazai és külföldi főzdéktől.', 'sorfesztival.jpg'),
(27, 'Nyári Rockfesztivál', 'Békéscsaba, Ifjúsági Park', '2026-07-22 17:00:00', 'Élő rockzene és fantasztikus hangulat vár!', 'rockfesztival.jpg'),
(28, 'Húsvéti Tojásvadászat', 'Eger, Érsekkert', '2026-04-05 10:00:00', 'Családi program gyerekeknek, húsvéti játékokkal és kézműves foglalkozásokkal.', 'husvetitojasvadaszat.jpg'),
(29, 'Filmklub – Kultikus Filmek', 'Pécs, Film Múzeum', '2026-09-10 20:00:00', 'Klasszikus filmek vetítése és közönségtalálkozó.', 'filmklub.jpg'),
(30, 'Társasjáték Nap', 'Sopron, Ifjúsági Központ', '2026-02-14 13:00:00', 'Próbálj ki új és klasszikus társasjátékokat barátaiddal.', 'tarsasjateknap.jpg'),
(31, 'Olasz Gasztro Napok', 'Budapest, Olasz Étterem Negyed', '2026-06-01 11:00:00', 'Kóstold meg az autentikus olasz konyha remekeit!', 'olaszgasztro.jpg'),
(32, 'Vitorlásverseny', 'Balaton, Keszthely', '2026-07-29 09:00:00', 'Izgalmas vitorlásversenyek amatőr és profi hajósoknak.', 'vitorlasverseny.jpg'),
(33, 'Szent Iván-éji Tűzugrás', 'Szeged, Tisza-part', '2026-06-24 22:00:00', 'Hagyományőrző tűzugrás és éjszakai mulatság.', 'tuzugras.jpg'),
(34, 'Startup Expo', 'Budapest, Kongresszusi Központ', '2026-10-10 09:00:00', 'Innovatív startupok bemutatkozása, befektetők és szakemberek részvételével.', 'startupexpo.jpg'),
(35, 'Középkori Falunap', 'Hollókő, Fő tér', '2026-05-08 10:00:00', 'Hagyományőrző programok, kézműves foglalkozások és korhű bemutatók.', 'kozepkorifalunap.jpg'),
(36, 'Termelői Piac', 'Nyíregyháza, Városi Piac', '2026-04-18 08:00:00', 'Friss helyi termékek és bio élelmiszerek vására.', 'termeloipiac.jpg'),
(37, 'Jótékonysági Futás', 'Miskolc, Városi Stadion', '2026-09-15 09:30:00', 'Fuss egy jó ügyért és támogasd a rászorulókat!', 'jotekonysagifutas.jpg'),
(38, 'Halloween Party', 'Budapest, Ruin Pub', '2026-10-31 20:00:00', 'Jelmezes buli, horror filmvetítés és különleges koktélok.', 'halloweenparty.jpg'),
(39, 'Robotverseny', 'Debrecen, Egyetem', '2026-11-05 10:00:00', 'Programozd meg a saját robotod és nyerj!', 'robotverseny.jpg'),
(40, 'Téli Sportfesztivál', 'Eplény, Síaréna', '2026-12-15 08:00:00', 'Síelés, snowboard és téli sportok versenye.', 'telisportfesztival.jpg');
...
INSERT INTO `felhasznalo` (`Id`, `FelhasznaloNev`, `TeljesNev`, `SALT`, `HASH`, `Email`, `Jogosultsag`, `Aktiv`, `RegisztracioDatuma`, `FenykepUtvonal`, `Telefonszam`, `Orszag`) VALUES
(1, 'LakatosI', 'Lakatos István', 'jQGX8grO1yjNqhiZbtROcseiqj1NVZJd2iqlfxPx1GKLJ9H8smnLJ9dloScCK6Zp', 'dcedbd2d352d19c6eae0dfb12271b74d985c825b8d774afd2abd0d101b6e57ef', 'lakatosi@gmail.com', 9, 1, '2024-11-25 07:33:49', 'lama.jpg', '+36213007139', 'Magyar ország'),
(2, 'TothB', 'Tóth Béla', 'e3wD2TNpdVUBmBOpj5ErZqjLrye9Kr4cjuCCb7MSW8V8Hgb6vd6IdOc98LS7mFpi', '63edcf4d138606e9258778d3c7a342f0ed24ac49cda7372c1712a89fa3d73ebc', 'sulla.spqr78@gmail.com', 9, 1, '2025-02-06 19:07:24', 'auris.jpg', '+37213107139', 'Német ország'),
(3, 'NagyV', 'Nagy Virág', '4540de2854ff8be8b4eb412b40ef0d83ce4c80eb2d8abc9512458ae6444c5fe0', '14fe5b31efd0ce0c378765e680de4590b4cd6041469209f9d40ea6af79684041', 'nagyv@gmail.com', 0, 0, '2024-11-25 07:36:46', '', '+36653007139', 'Lengyel ország'),
(10, 'TothA', 'Toth Attila', 'OK6CKIRazwHb4A7jJUogeiSMxZqJuTqi5VMbsiq8BRHc19osWOBUQiTU6Y0h5ZW4', 'a13ec19d5697f88944e1b1d13ae9058faee2bf6f677370bef50a8347b81b9174', 'feherd@kkszki.hu', 1, 0, '2025-01-22 07:55:42', 'default.jpg', '+36213007345', 'Egyesült Államok');
